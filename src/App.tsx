                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-xs flex items-center justify-between">
                    <div>
                      ...
                      <span className="font-display text-4xl font-black text-slate-900 block">
                        {cachedOptimization.originalAnalysis.score}
                        <span className="text-sm font-normal text-slate-500"> / 100 max</span>
                      </span>
                  ...
                  <div className={`rounded-xl border p-5 shadow-xs flex items-center justify-between ${
                    ...
                    <div>
                      ...
                      <span className={`font-display text-4xl font-black block ${
                        ...
                        {cachedOptimization.optimizedAnalysis.score}
